...
public class ContentCategoryController {
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody ContentCategory contentCategory, @PathVariable Integer id){
        //设置主键值
    ...
    public Result<List<ContentCategory>> findAll(){
        List<ContentCategory> contentCategories = contentCategoryService.findAll();
        return new Result<>(true, StatusCode.OK,"查找所有成功！" ,contentCategories);
    }
