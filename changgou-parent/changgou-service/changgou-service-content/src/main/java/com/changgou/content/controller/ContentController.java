...
public class ContentController {
    ...
    public Result<List<Content>> findByCategory(@PathVariable("id") Integer categoryId){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  Content content,@PathVariable Integer id){
        //设置主键值
        content.setId(id);
    ...
    public Result<List<Content>> findAll(){
        ...
        return new Result<>(true, StatusCode.OK,"查找所有成功！" ,contentList);
    }
